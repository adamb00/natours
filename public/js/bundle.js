...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYWRhbWIwMCIsImEiOiJjbDk1aXE0d2gwZTZrM29xcW5nbGNuNXBzIn0.d6gIzxUSy9oZqV7W0N4R9g';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/adamb00/cl95j0vko001214o6fii3fa06',
    scrollZoom: false
  });
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51LtASpCBtn53vFV4xUPJ8tNRK5QLEsNTmCwDsW7eDTea1J5udeG2y5Hj6sjMhmxUje6ysMcY1paL4L5Ie0SXyjhv00MKN89Uyo'); // const stripe = await loadStripe(
...
if (userDataForm) userDataForm.addEventListener('submit', function (e) {
  ...
  form.append('emal', document.getElementById('email').value);
